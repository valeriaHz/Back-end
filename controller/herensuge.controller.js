...
var HerensugeBeltza = /*#__PURE__*/function () {
  function HerensugeBeltza(url, data, method) {
    var _this = this;
    _classCallCheck(this, HerensugeBeltza);
    _defineProperty(this, "consulta", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var respuesta, datos;
...
function enviarDatos() {
  ...
  var enviar = new HerensugeBeltza('http://backend.val', datos, 'POST');
  enviar.insercion();
}
...
var mis_input = ["nombre", "email", "password"];
var Validacion = /*#__PURE__*/function (_Interfaz) {
  ...
  function Validacion() {
    ...
    _this2 = _callSuper(this, Validacion, [].concat(args));
    _defineProperty(_assertThisInitialized(_this2), "limpiar_cadena", function (cadena, caracter_busqueda, caracter_remplazo) {
      return cadena.replace("".concat(caracter_busqueda), "".concat(caracter_remplazo));
    });
    _defineProperty(_assertThisInitialized(_this2), "caracter_mayus", function (input) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "limitar_valor", function (input, inicio, fin, msj) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "longitud_campo", function (input, inicio, fin, msj) {
    ...
    _defineProperty(_assertThisInitialized(_this2), "longitud_campo_exacta", function (input, longitud, msj) {
      var campo = document.getElementsByName("".concat(input))[0].value;
